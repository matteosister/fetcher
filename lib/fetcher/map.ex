defmodule Fetcher.Map do
  ...
  @spec do_fetch_params(map, [term], map, Fetcher.options()) :: result
  defp do_fetch_params(_params, [], acc, _options), do: {:ok, acc}
  ...
  defp handle_result(result, _source, _required_params, _options), do: result
